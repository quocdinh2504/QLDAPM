    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <p>
                    <a href="{{ route('admin.hangsanxuat.them') }}" class="btn btn-info"><i class="fa-solid fa-plus"></i> Thêm mới</a>
                    
                    <a href="#nhap" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#importModal">
                        <i class="fa-solid fa-upload"></i> Nhập Excel
                    </a>
                    
                    <a href="{{ route('admin.hangsanxuat.xuat') }}" class="btn btn-warning">
                    ...
                    <tbody>
                        @foreach ($hangsanxuat as $value)
                            <tr>
                                ...
                                <td class="text-center"><a href="{{ route('admin.hangsanxuat.sua', ['id' => $value->id]) }}"><i class="fa-solid fa-pen-to-square text-warning"></i></a></td>
                                <td class="text-center"><a href="{{ route('admin.hangsanxuat.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa nhà cung cấp {{ $value->tenhang }} không?')"><i class="fa-solid fa-trash-can text-danger"></i></a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
